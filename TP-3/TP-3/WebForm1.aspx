...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Button ID="btnGuardarLocalidad" runat="server" style="margin-left: 242px; margin-bottom: 0px" Text="Guardar Localidad" Width="132px" OnClick="btnGuardarLocalidad_Click" />
        </p>
        <p>
        ...
        <p>
            ...
            <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="tbxNombreUsuario" ErrorMessage="Ingrese el nombre"></asp:RequiredFieldValidator>
        </p>
        <p>
            <asp:Label ID="Label4" runat="server" Text="Contraseña:"></asp:Label>
            <asp:TextBox ID="tbxContraseña" runat="server" style="margin-left: 120px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvPass" runat="server" ControlToValidate="tbxContraseña" ErrorMessage="Seleccione su password"></asp:RequiredFieldValidator>
        </p>
        <p>
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="tbxContraseña" ControlToValidate="tbxRepetirContraseña" ErrorMessage="Las password no coinciden"></asp:CompareValidator>
        </p>
        ...
        <p>
            ...
            <asp:RequiredFieldValidator ID="rfvCP" runat="server" ControlToValidate="tbxCp" ErrorMessage="Ingrese el codigo postal"></asp:RequiredFieldValidator>
        </p>
